...
#define MySourceDir "E:\rust\zsclip\dist\installer-source-no-lan"
...
AppVerName={#MyAppName} {#MyAppVersion} 无局域网同步
...
OutputBaseFilename=zsclip-v{#MyAppVersion}-setup-no-lan
...
VersionInfoDescription={#MyAppName} 无局域网同步
