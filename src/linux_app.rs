...
use crate::app_core::{
    ...
    ComponentPhase, LifecycleEvent, LifecycleState, MainRowExternalActionPlan, MainRowMenuAction,
    NativeAiActionMenuRequest, NativeAiActionPresenter, NativeAiSettingsSurfaceRequest,
    NativeAppIconResource, NativeAutostartApplyResult, NativeAutostartHost, NativeAutostartStatus,
    NativeControlMapper, NativeDialogButtons, NativeDialogHost, NativeDialogLevel,
    NativeDialogResponse, NativeEditTextDialogHost, NativeEditTextDialogRequest,
...
impl NativeStyleResolver for LinuxNativeStyleResolver {
    fn resolve_text_style(&self, style: SemanticTextStyle) -> TextStyle {
        ...
        let color = match style.color {
            ...
            ColorRole::Border => Color {
                r: 209,
                g: 209,
                b: 209,
                a: 255,
            },
            ColorRole::Success => Color {
                r: 15,
                g: 123,
                b: 15,
                a: 255,
            },
            ColorRole::Warning => Color {
                r: 157,
                g: 93,
                b: 0,
                a: 255,
