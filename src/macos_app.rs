...
use crate::app_core::{
    ...
    settings_lan_pair_status_projection, settings_lan_sync_action_support_plan, ApplicationEvent,
    ...
    MainPointerDownTarget, MainRenderInput, MainRowExternalActionPlan, MainRowMenuAction,
    MainShortcutAction, MainShortcutEscapePlan, MainShortcutExecutionPlan, MainUiLayout,
    MainVvPopupHit, MainVvPopupLayout, MainVvPopupRenderItem, MainVvPopupRenderStrings,
    MainVvSelectPlan, NativeAiActionMenuRequest, NativeAiActionPresenter,
    NativeAiSettingsSurfaceRequest, NativeAppIconResource, NativeAutostartApplyResult,
    NativeAutostartHost, NativeAutostartStatus, NativeDialogButtons, NativeDialogHost,
    NativeDialogLevel, NativeDialogResponse, NativeEditTextDialogHost, NativeEditTextDialogRequest,
    NativeEditTextDialogResult, NativeEditTextSaveHandler, NativeFileDialogHost,
    NativeFileDialogRequest, NativeHostClipListItemProjection, NativeHostClipboardWrite,
    NativeHostDialogAction, NativeHostLaunchMode, NativeHostLaunchPlan, NativeHostRowAction,
    NativeHostSearchTextAction, NativeHostSettingsAction, NativeHostSettingsControlAction,
    NativeHostSettingsPlatformAction, NativeHostStatusMenuAction, NativeHostUiAction,
    NativeHostVvPasteExecution, NativeHostVvPastePlan, NativeHostVvTriggerAction,
    NativeHostVvTriggerInput, NativeHostVvTriggerState, NativeHostVvTriggerTransition,
    NativeImeCandidateAnchor, NativeImeCompositionAnchor, NativeImeHost, NativeMailMergeWindowHost,
    ...
    NativeTransientWindowPresentation, NativeTransientWindowRequest, NativeUiToolkit,
    NativeWindowIdentityHost, NativeWindowOptions, NativeWindowToken, PasteTargetFocusStatus,
