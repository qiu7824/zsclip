...
pub use crate::settings_model::{
    SCROLL_BAR_MARGIN, SCROLL_BAR_W, SCROLL_BAR_W_ACTIVE, SettingsFormSectionLayout,
};
pub use crate::settings_render::{
    ...
    IDC_SET_GROUP_ENABLE, IDC_SET_GROUP_LIST, IDC_SET_GROUP_RENAME, IDC_SET_GROUP_UP, IDC_SET_GROUP_VIEW_PHRASES,
    IDC_SET_GROUP_VIEW_RECORDS, IDC_SET_HOVERPREVIEW, IDC_SET_IMAGE_PREVIEW, IDC_SET_MAX, IDC_SET_OCR_CLOUD_TOKEN,
    IDC_SET_OCR_CLOUD_URL, IDC_SET_OCR_WECHAT_DETECT, IDC_SET_PASTE_SOUND_ENABLE, IDC_SET_PASTE_SOUND_KIND, IDC_SET_PASTE_SOUND_PICK, IDC_SET_PERSIST_SEARCH,
    IDC_SET_PLAIN_HK_ENABLE, IDC_SET_PLAIN_HK_KEY, IDC_SET_PLAIN_HK_MOD,
    IDC_SET_PLUGIN_DOWNLOADS, IDC_SET_OCR_PROVIDER, IDC_SET_OPEN_SOURCE, IDC_SET_OPEN_UPDATE, IDC_SET_PASTE_MOVE_TOP,
    IDC_SET_DEDUPE_FILTER, IDC_SET_PLUGIN_MAILMERGE, IDC_SET_POSMODE, IDC_SET_QUICK_DELETE, IDC_SET_SAVE,
    IDC_SET_SILENTSTART, IDC_SET_TRAYICON, IDC_SET_AUTOHIDE_BLUR, IDC_SET_VV_GROUP,
    IDC_SET_VV_MODE, IDC_SET_VV_SOURCE, IDC_SET_HK_RECORD,
    IDC_SET_TRANSLATE_PROVIDER, IDC_SET_TRANSLATE_TARGET,
    SETTINGS_CLASS,
};
