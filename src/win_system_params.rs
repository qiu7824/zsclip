...
pub use crate::settings_render::{
    ...
    IDC_SET_GROUP_VIEW_RECORDS, IDC_SET_HOVERPREVIEW, IDC_SET_IMAGE_PREVIEW, IDC_SET_MAX, IDC_SET_OPEN_SOURCE,
    IDC_SET_OPEN_UPDATE, IDC_SET_PASTE_MOVE_TOP, IDC_SET_DEDUPE_FILTER, IDC_SET_PLUGIN_MAILMERGE, IDC_SET_POSMODE,
    IDC_SET_QUICK_DELETE, IDC_SET_SAVE, IDC_SET_SILENTSTART, IDC_SET_TRAYICON, IDC_SET_AUTOHIDE_BLUR,
    IDC_SET_VV_GROUP, IDC_SET_VV_MODE, IDC_SET_VV_SOURCE, IDC_SET_HK_RECORD, SETTINGS_CLASS,
};
