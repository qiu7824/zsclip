...
pub(in crate::app) use crate::app_core::{
    clamp_window_pos_to_rect, main_copy_selection_plan, main_group_filter_menu_plan,
    ...
    native_host_group_filter_popup_menu_entries_for_groups, native_host_main_action_button_specs,
    native_host_main_tool_button_specs, native_host_row_action_button_specs,
    parse_search_query_with_context, set_settings_ui_dpi, settings_content_y_scaled,
    settings_h_scaled, settings_scale, settings_w_scaled, ApplicationEvent, ClipListState,
    ClipboardHost, Command, CommandPayload, CommandQueue, CommandScope, DpiCompensationState,
    HorizontalAlign, ImagePasteReadyResult, ImageThumbReadyResult, ImageThumbnail, ItemsCursor,
    ItemsQuery, KeyState as UiKeyState, LifecycleEvent, LifecycleState, MainActivateSelectionPlan,
...
pub(crate) use crate::app_core::{ClipGroup, ClipItem, ClipKind};
...
pub(in crate::app) use crate::win_system_params::{
    ...
    IDC_SET_GROUP_UP, IDC_SET_GROUP_VIEW_PHRASES, IDC_SET_GROUP_VIEW_RECORDS, IDC_SET_HK_RECORD,
    IDC_SET_HOTKEY_KEY, IDC_SET_HOTKEY_MOD, IDC_SET_HOVERPREVIEW, IDC_SET_IMAGE_PREVIEW,
    IDC_SET_LAN_ACCEPT_PAIR, IDC_SET_LAN_COPY_PAIR, IDC_SET_LAN_COPY_SETUP,
    IDC_SET_LAN_DISCOVERED_LIST, IDC_SET_LAN_DOCS, IDC_SET_LAN_ENABLE, IDC_SET_LAN_MANUAL_HOST,
    IDC_SET_LAN_NAME, IDC_SET_LAN_PAIR, IDC_SET_LAN_QR_ANDROID, IDC_SET_LAN_QR_IOS,
    IDC_SET_LAN_RECEIVE_MODE, IDC_SET_LAN_REFRESH, IDC_SET_LAN_REJECT_PAIR, IDC_SET_LAN_TCP_PORT,
    IDC_SET_MAX, IDC_SET_MULTI_SYNC_MODE, IDC_SET_OCR_CLOUD_TOKEN, IDC_SET_OCR_CLOUD_URL,
    ...
    IDC_SET_PLAIN_HK_KEY, IDC_SET_PLAIN_HK_MOD, IDC_SET_PLUGIN_MAILMERGE, IDC_SET_POSMODE,
    IDC_SET_QUICK_DELETE, IDC_SET_SAVE, IDC_SET_SEARCH_ENGINE, IDC_SET_SILENTSTART,
    IDC_SET_SKIP_WINDOW_CAPTURE, IDC_SET_SKIP_WINDOW_CLASSNAMES, IDC_SET_SKIP_WINDOW_ENABLE,
    IDC_SET_TRANSLATE_PROVIDER, IDC_SET_TRANSLATE_TARGET, IDC_SET_TRAYICON, IDC_SET_VV_GROUP,
    IDC_SET_VV_MODE, IDC_SET_VV_SOURCE, IDC_SET_WPS_TASKPANE_DOCS, SCROLL_BAR_MARGIN, SCROLL_BAR_W,
    SCROLL_BAR_W_ACTIVE,
};
