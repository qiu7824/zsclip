...
pub(crate) struct AppSettings {
    ...
    pub(crate) dark_mode_enabled: bool,
    ...
    pub(crate) copy_success_sound_enabled: bool,
...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            ...
            dark_mode_enabled: platform_appearance::system_is_dark_mode(),
            click_hide: false,
            ...
            copy_success_sound_enabled: false,
...
pub(crate) struct AppState {
    ...
    pub(crate) search_brush: *mut core::ffi::c_void,
    ...
    pub(crate) hover_delete_idx: i32,
    ...
    pub(crate) clipboard_terminal_sequence: u32,
    ...
    pub(crate) vv_popup_trigger_text_visible: bool,
    ...
    pub(crate) paste_focus_retry_attempts: u8,
...
pub(super) struct PageLoadResult {
    ...
    pub(super) app_data_generation: u64,
...
impl AppState {
    pub(super) fn new(
        ...
        let (mut settings, app_data_generation) = load_settings_with_generation();
        ...
        platform_appearance::set_dark_mode_enabled(settings.dark_mode_enabled);
