...
pub(super) fn settings_toggle_general_get(st: &SettingsWndState, cid: isize) -> Option<bool> {
    match cid {
        ...
        IDC_SET_APP_ICON_VISIBLE => Some(st.draft.app_icon_visible),
        IDC_SET_DARK_MODE => Some(st.draft.dark_mode_enabled),
        ...
        IDC_SET_COPY_SOUND_ENABLE => Some(st.draft.copy_success_sound_enabled),
        ...
        IDC_SET_CONTEXT_MENU_COPY => Some(st.draft.context_menu_copy_enabled),
        _ => None,
    }
}
...
pub(super) fn settings_toggle_general_flip(st: &mut SettingsWndState, cid: isize) -> bool {
    match cid {
        ...
        IDC_SET_APP_ICON_VISIBLE => st.draft.app_icon_visible = !st.draft.app_icon_visible,
        IDC_SET_DARK_MODE => st.draft.dark_mode_enabled = !st.draft.dark_mode_enabled,
        ...
        IDC_SET_COPY_SOUND_ENABLE => {
            st.draft.copy_success_sound_enabled = !st.draft.copy_success_sound_enabled
        }
        ...
        IDC_SET_CONTEXT_MENU_COPY => {
            st.draft.context_menu_copy_enabled = !st.draft.context_menu_copy_enabled
        }
        _ => return false,
    }
    true
