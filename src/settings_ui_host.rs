...
use crate::win_system_params::{
    IDC_SET_APP_ICON_VISIBLE, IDC_SET_AUTOHIDE_BLUR, IDC_SET_AUTOSTART, IDC_SET_BTN_OPENCFG,
    IDC_SET_CLICK_HIDE, IDC_SET_CLIPBOARD_HISTORY_DISABLE, IDC_SET_CLIPBOARD_HISTORY_ENABLE,
    IDC_SET_CLOSE, IDC_SET_CLOSETRAY, IDC_SET_CLOUD_APPLY_CFG, IDC_SET_CLOUD_ENABLE,
    IDC_SET_CLOUD_INTERVAL, IDC_SET_CLOUD_RESTORE_BACKUP, IDC_SET_CLOUD_SYNC_NOW,
    IDC_SET_CLOUD_UPLOAD_CFG, IDC_SET_CONTEXT_MENU_COPY, IDC_SET_COPY_SOUND_ENABLE,
    IDC_SET_DARK_MODE, IDC_SET_DEDUPE_FILTER, IDC_SET_EDGEHIDE, IDC_SET_GROUP_ADD,
    IDC_SET_GROUP_DELETE, IDC_SET_GROUP_DOWN, IDC_SET_GROUP_ENABLE, IDC_SET_GROUP_LIST,
    IDC_SET_GROUP_RENAME, IDC_SET_GROUP_TYPE_FILTER, IDC_SET_GROUP_UP, IDC_SET_GROUP_VIEW_PHRASES,
    ...
    IDC_SET_MAX, IDC_SET_MOUSE_SIDE_BUTTON_1, IDC_SET_MOUSE_SIDE_BUTTON_2,
    IDC_SET_MOUSE_SIDE_ENABLE, IDC_SET_MULTI_SYNC_MODE, IDC_SET_OCR_PROVIDER,
    ...
    IDC_SET_PLUGIN_AI_CLEAN, IDC_SET_PLUGIN_MAILMERGE, IDC_SET_PLUGIN_QR_QUICK,
    IDC_SET_PLUGIN_SEARCH, IDC_SET_PLUGIN_SUPER_MAIL_MERGE, IDC_SET_PLUGIN_WPS_TASKPANE,
    IDC_SET_POSMODE, IDC_SET_QUICK_DELETE, IDC_SET_RESTART_EXPLORER, IDC_SET_SAVE,
    IDC_SET_SEARCH_ENGINE, IDC_SET_SEARCH_ENGINE_RESET, IDC_SET_SILENTSTART,
...
mod tests {
    ...
    fn settings_host_control_ids_map_to_roles_and_refresh_pages() {
        ...
        assert_eq!(
            settings_control_role_for_control(IDC_SET_DARK_MODE),
            Some(SettingsControlRole::Toggle)
        );
        assert_eq!(
            settings_control_role_for_control(IDC_SET_APP_ICON_VISIBLE),
            Some(SettingsControlRole::Toggle)
        );
        assert_eq!(
            settings_control_role_for_control(IDC_SET_CONTEXT_MENU_COPY),
            Some(SettingsControlRole::Toggle)
        );
        assert_eq!(
            settings_command_for_control(IDC_SET_APP_ICON_VISIBLE),
            Some(crate::app_core::Command::window_with_payload(
                crate::app_core::command_ids::TOGGLE_SETTINGS_CONTROL,
                crate::app_core::CommandPayload::ControlId(IDC_SET_APP_ICON_VISIBLE as i64)
            ))
        );
        assert_eq!(
            settings_command_for_control(IDC_SET_CONTEXT_MENU_COPY),
            Some(crate::app_core::Command::window_with_payload(
                crate::app_core::command_ids::TOGGLE_SETTINGS_CONTROL,
                crate::app_core::CommandPayload::ControlId(IDC_SET_CONTEXT_MENU_COPY as i64)
            ))
        );
        assert_eq!(
            settings_control_role_for_control(IDC_SET_COPY_SOUND_ENABLE),
            Some(SettingsControlRole::Toggle)
        );
        assert_eq!(
