...
> 文本、图片、文件、短语、分组、VV 模式、拖出生成文件、贴图、超级邮件合并，一套完成。

## 下载

- GitHub 发布页: <https://github.com/qiu7824/zsclip/releases/tag/v0.2.0>
...
- 快速搜索
- 悬停预览
- `VV` 模式：输入 `vv` 后在输入位置弹出候选窗，继续按 `1-9` 直接粘贴对应记录
- 图片贴图悬浮窗
- 导出为文件
- 文本、图片、文件支持拖出
...
6. 如果开启 `VV` 模式，在 Word、微信、记事本等输入场景中直接输入 `vv`，再按 `1-9` 可快速插入候选内容
